...
def check_FAQ(question):
    ...
    if all_questions_data:
        ...
        most_similar_question_index, similarity_score = get_similar_question_index(question, all_questions)

        if similarity_score > 0.7:  # If the cosine similarity is greater than 70%
            return True, all_answers[most_similar_question_index]
